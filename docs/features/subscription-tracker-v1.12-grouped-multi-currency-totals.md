...
- Runtime/app shell: `v1.12.4`, local implementation pending user review.
...
- Final UI consistency polish aligns grouped currency total typography and color with Upcoming payment amounts.
...
## Final UI Consistency Polish Scope

- Align Spending Overview totals, Due soon grouped chips, Actual range grouped chips, and Upcoming payment amounts around the same accent color, strong weight, and tabular numeric treatment.
- Keep calculations, labels, layouts, storage, backup, and Range behavior unchanged.
- Bump app shell/cache references to `v1.12.4`.
...
- [x] Grouped currency total typography and color are visually consistent across overview, Due soon, Actual range, and Upcoming payment amount displays.
...
- 2026-05-06: Implemented v1.12.4 UI consistency polish locally. Spending Overview totals, Due soon chips, Actual range chips, and Upcoming payment amounts now share the same currency amount typography/color treatment while preserving existing calculations and behavior.
